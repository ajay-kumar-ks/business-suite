    ...
    <div className="module-page">
      ...
      <div className="accounts-summary">
        ...
        <form onSubmit={handleSubmit} className="accounts-form">
          <Input id="code" label="Account Code" value={form.account_code} onChange={(e) => setForm({ ...form, account_code: e.target.value })} />
          <Input id="name" label="Account Name" value={form.account_name} onChange={(e) => setForm({ ...form, account_name: e.target.value })} />
          <label className="ui-input-label" htmlFor="type">Account Type</label>
          <select id="type" className="ui-input-field" value={form.account_type} onChange={(e) => setForm({ ...form, account_type: e.target.value })}>
            <option>Asset</option>
